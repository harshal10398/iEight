...
public class Insight {
    ...
    private static final String getTaakaMonthlyCountAndTotalLengthQuery="SELECT COUNT(*) AS TAAKA_COUNT, SUM(TAAKA_LENGTH) AS TOTAL_LENGTH, YEAR(PRODUCTION_DATE) AS YEAR, MONTH(PRODUCTION_DATE) AS MONTH FROM TAAKA GROUP BY YEAR(PRODUCTION_DATE), MONTH(PRODUCTION_DATE)";
    private static final String getCollectionMonthlyCountQuery="SELECT COUNT(*) AS COLLECTION_COUNT, YEAR(ENTRY_DATE) AS YEAR, MONTH(ENTRY_DATE) AS MONTH FROM COLLECTION_BOOK GROUP BY YEAR(ENTRY_DATE), MONTH(ENTRY_DATE)";
    ...
    public JsonNode getInsights() throws SQLException {
